...
<form class="space-y-6">
    <div class="grid grid-cols-2 gap-6 p-6 sm:grid-cols-2">
        <div>
            <label for="coordinator_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Coordinador</label>
            <select id="coordinator_id" wire:model='coordinator_id' class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                <option value="Seleccion">Selecciones Una Opcion</option>
                @foreach ($coordi as $item2)
        ...
        <div>
            <label for="agent_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Agentes</label>
                <select id="agent_id" wire:model='agent_id' class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    <option value="Seleccion">Selecciones Una Opcion</option>
                    @foreach ($agent as $item3)
        ...
        <div>
            <label for="activist_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Activista</label>
                <select id="activist_id" wire:model='activist_id' class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    <option value="Seleccion">Selecciones Una Opcion</option>
                    @foreach ($activist as $item4)
        ...
        <div>
            <label for="street" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Dirección</label>
            <input type="text" wire:model='street' id="street" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Dirección">
            @error('street')
                <p class="mt-2 text-sm text-red-600 dark:text-red-500"><span class="font-medium">{{ $message }}</span></p>
            @enderror
        </div>
